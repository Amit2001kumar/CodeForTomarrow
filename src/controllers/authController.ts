...
const generateToken = (userId: string): string => {
  return jwt.sign({ userId }, secretKey, { expiresIn: '1h' }); // Adjust expiry time as needed
};

// Controller function for user registration (insert)
...
export default { register, login, updateUser, deleteUser };
